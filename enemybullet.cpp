...
//			{// プレイヤーの弾
//				// エフェクトの設定
//				SetEffect(pBullet->pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXCOLOR(0.25f, 0.1f, 0.25f, 1.0f), 30.0f, 50);
//				SetEffect(pBullet->pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXCOLOR(0.75f, 0.1f, 0.75f, 1.0f), 40.0f, 50);
//				SetParticle(pBullet->pos, D3DXCOLOR(1.0f, 0.0f, 1.0f, 1.0f), 1500.0f, 3);
//				// 敵との当たり判定
...
//				SetParticle(pBullet->pos, D3DXCOLOR(0.64f, 0.88f, 0.49f, 1.0f), 300.0f, 3);
//				// プレイヤーとの当たり判定
...
//			pVtx[3].pos.z = 0.0f;
//
//			g_aBullet[nCntBullet].move.x = sinf(fAngle) * fmove;
//			g_aBullet[nCntBullet].move.y = cosf(fAngle) * fmove;
//
//			g_aBullet[nCntBullet].nLife = nLife;
//			g_aBullet[nCntBullet].type = type;
